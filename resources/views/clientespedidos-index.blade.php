...
<head>
 ...
 <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <title>Relatório de Clientes Pedidos</title>
</head>
<body>
    ...
    <hr><a class="btn btn-success btn-sm" href="/pc/create">Cadastrar Clientes/Pedidos</a>
    ...
    <div class="row">
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <tbody>                         
            <tr>
              @foreach($clientespedidos as $clientespedido)
                <td class="text-center">
                  {{$clientespedido['id']}}
                </td>
                <td class="text-center">
                    {{$clientespedido['clientes_id']}}
                </td>
                <td class="text-center">
                  {{$clientespedido['pedidos_id']}}
                </td>
                <td class="text-center">
                  <a class="btn btn-success btn-sm" href="/pc/ver/{{$clientespedido['id']}}">Visualizar</a>
                  <a class="btn btn-warning btn-sm" href="/pc/editar/{{$clientespedido['id']}}">Editar</a>
                  <form name="form_delete" action="{{ route('pc.destroy',$clientespedido['id']) }}" method="post">
                    @csrf
