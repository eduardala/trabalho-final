...
<body>
    ...
    <form action="{{ route('documentos.update', ['id' => $documentos->id]) }}" method="POST">
        @csrf
        <div class="row">
            <div class="form-group col-md-4">
              <label for="campo1">Tipo de Documento</label>
              <input type="text" class="form-control" name="tipoDocumento" id="tipoDocumento" value="{{ $documentos['tipoDocumento']}}" readonly>
            </div><br>

            <div class="form-group col-md-2">
                <label for="campo2">Número do Documento</label>
                <input type="text" class="form-control" name="numeroDocumento" id="numeroDocumento" value="{{ $documentos['numeroDocumento']}}">
              </div><br>
            <div class="form-group col-md-4">
                <p>
