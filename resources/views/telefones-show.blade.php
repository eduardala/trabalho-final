    ...
    <div id="main" class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <p><strong>Tipo de Telefone</strong></p>
                <p>{{ $telefones['tipoTelefone']}}</p>
            </div> 

            <div class="col-md-4">
                <p><strong>Número do telefone</strong></p>
                <p>{{ $telefones['numeroTelefone']}}</p>
            </div> 
            <div class="col-md-4">
                <p><strong>Cliente</strong></p>
                <p>{{ $telefones['clientes_id']}}</p>
            </div> <br>
            <div id="actions" class="row">
                <div class="col-md-12">
                <a href="/telefones/editar/{{$telefones['id']}}" class="btn btn-primary">Editar</a>
                <a href="/telefones" class="btn btn-default">Fechar</a>
            </div>
        </div>
    </div>
</body>
