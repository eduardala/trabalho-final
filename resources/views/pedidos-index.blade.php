...
<body>
    ...
    <hr><a class="btn btn-success btn-sm" href="/pedidos/create">Cadastrar Pedidos</a>
    <div class="row">
        <table class="table table-striped" cellspacing="0" cellpadding="0">
            ...
            <tr>
              @foreach($pedidos as $pedido)
                ...
                <td class="btn-group">
                  <a class="btn btn-success btn-sm" href="/pedidos/ver/{{$pedido['id']}}">Visualizar</a>
                  <a class="btn btn-warning btn-sm" href="/pedidos/editar/{{$pedido['id']}}">Editar</a>
                  <form name="form_delete" action="{{ route('pedidos.destroy',$pedido['id']) }}" method="post">
                    @csrf
